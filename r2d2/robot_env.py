...
class RobotEnv(gym.Env):
    ...
    def step(self, action):
        ...
        newdict['lowdim_obs'] = np.concatenate([frankaobs, np.asarray([self.get_gripper_pos()])])
        newdict['third_person_img_obs'] = self.get_images()
        return newdict, 0, (self.curstep >= 300), {}
